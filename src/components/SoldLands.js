            ...
            land.owner === account ? 
              <td>
                ...
                <button 
                  ...
                  className="buyButton"
                  onClick={ (e) => { 
                      if (e.target.value === undefined || e.target.value === 0 || e.target.value === null || e.target.value === '') {
                          alert("Please key in a valid listing price")
                      } else {
                        listLand(land.landID, window.web3.utils.toWei(e.target.value.toString(), 'Ether')) 
                      }
